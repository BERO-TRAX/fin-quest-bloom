...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'about.desc': { en: 'FinQuest combines RPG simulation (inspired by Cashflow) with psychology-driven gamification: autonomy, competence, and relatedness. The goal isn\'t "a game for points" — it\'s lasting financial habits.', bg: 'FinQuest съчетава RPG симулация (вдъхновена от Cashflow) с геймификация, базирана на психология: автономия, компетентност и свързаност. Целта не е "игра за точки" — а трайни финансови навици.' },
  ...
  // Features
  'features.eyebrow': { en: 'FinQuest in 60 Seconds', bg: 'FinQuest за 60 секунди' },
  ...
  'trust.archDesc': { en: 'Instead of dark patterns, FinQuest uses clear messaging, unobtrusive security indicators, and progressive disclosure of details.', bg: 'Вместо тъмни модели, FinQuest използва ясни съобщения, ненатрапчиви индикатори за сигурност и постепенно разкриване на детайли.' },
  ...
  // CTA
  'cta.eyebrow': { en: 'FinQuest • Early Vision', bg: 'FinQuest • Ранна визия' },
  ...
  'aboutPage.sparkDesc': { en: 'During a late-night gaming session, one of us said: "Why can\'t learning about money feel like this — like a quest where every decision matters and you actually see the consequences?" That question became the seed of FinQuest. We realized that the problem wasn\'t a lack of information — it was a lack of engagement. Financial education was boring, abstract, and disconnected from real life. What if we could change that by combining RPG mechanics with behavioral psychology?', bg: 'По време на късна гейминг сесия, един от нас каза: "Защо ученето за пари не може да се усеща ето така — като куест, в който всяко решение има значение и наистина виждаш последствията?" Този въпрос се превърна в семето на FinQuest. Осъзнахме, че проблемът не е липсата на информация — а липсата на ангажираност. Финансовото образование беше скучно, абстрактно и откъснато от реалния живот. Какво ако можехме да променим това, комбинирайки RPG механики с поведенческа психология?' },
  'aboutPage.missionTitle': { en: 'The Mission 🎯', bg: 'Мисията 🎯' },
  'aboutPage.missionDesc': { en: 'FinQuest was born from a simple belief: financial literacy should be a practice, not a lecture. We set out to build a platform where users learn by doing — making simulated financial decisions, seeing their consequences unfold in real-time, and receiving just-in-time lessons exactly when they need them. No dark patterns, no gambling mechanics, no toxic competition. Just meaningful progress toward real financial confidence.', bg: 'FinQuest се роди от просто убеждение: финансовата грамотност трябва да е практика, а не лекция. Заехме се да изградим платформа, в която потребителите учат чрез правене — вземайки симулирани финансови решения, виждайки последствията им в реално време и получавайки уроци точно когато са им нужни. Без тъмни модели, без хазартни механики, без токсична конкуренция. Само смислен прогрес към реална финансова увереност.' },
  'aboutPage.nowTitle': { en: 'Where We Are Now 🚀', bg: 'Къде сме сега 🚀' },
  'aboutPage.nowDesc': { en: 'Today, FinQuest is an early-stage vision — a demo of what financial education could look like when it\'s built with respect for the learner. We\'re refining our curriculum, testing simulation mechanics, and building toward a platform that helps people go from "financially anxious" to "financially confident," one quest at a time.', bg: 'Днес FinQuest е визия в ранен етап — демо на това как може да изглежда финансовото образование, когато е изградено с уважение към обучаемия. Усъвършенстваме учебната програма, тестваме симулационни механики и изграждаме платформа, която помага на хората да преминат от "финансово тревожни" към "финансово уверени," един куест наведнъж.' },
